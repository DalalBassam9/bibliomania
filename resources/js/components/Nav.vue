          ...
          >
            ...
            >
              <div class="flex-shrink-0 flex items-center">
                <router-link :to="'/'">
                <h3 class="text-xl text-Lightblue-500">ببلومانيا</h3>
                </router-link>
              </div>
            </div>
                ...
                <div class="w-full">
                  ...
                  <div class="relative">
                    ...
                    >
                      ...
                      <svg
                        class="h-5 w-5 text-Lightblue-500"
                    ...
                    <input
                      id="search"
                      name="search"
                      class="block w-full bg-Lightblue-100 border border-transparent rounded-md py-2 pl-10 pr-3 text-sm placeholder-gray-400 focus:outline-none  sm:text-sm"
            ...
            >
              <a
                href="#"
                class="ml-5 flex-shrink-0 bg-white rounded-full p-1 text-Lightblue-500  focus:outline-none "
              >
            ...
            -->
                <div
                  class="origin-top-right hidden absolute z-10 right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1 focus:outline-none"
                  role="menu"
