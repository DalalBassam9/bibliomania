<template>
    <div  v-if="authUser"  >
 <ul role="list" class="space-y-12 mt-6 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:grid-cols-3 lg:gap-x-8">
  ...
  width="20" viewBox="0 0 32 32" class="fill-current text-gray-400">
              <path d="M22.5,4c-2,0-3.9,0.8-5.3,2.2L16,7.4l-1.1-1.1C12,3.3,7.2,3.3,4.3,6.2c0,0-0.1,0.1-0.1,0.1c-3,3-3,7.8,0,10.8L16,29	l11.8-11.9c3-3,3-7.8,0-10.8C26.4,4.8,24.5,4,22.5,4z"></path></svg>
                             ...
                             <img
                                class="w-36 h-52 border-4     hover:shadow-xl transform hover:scale-105 transition duration-300   cursor-pointer   border-Lightblue-100  flex-shrink-0 mx-auto rounded-2xl"
